...
port = 1883
keepalive = 60
client_id =  "h20phisi@sensor"
sub_topic = "h20phisi/devices/node1/up"
pub_topic = "h20phisi/devices/node1/down"
pub_count = 1
...
def on_connect(client, userdata, flags, rc):
    if (rc == 0):
        ...
        # Init the publish to create roundloop from sensor-laptop and laptop-sensor
